...
namespace AudioSystem
{
	...
	public:
		...
		~SoundEffect();
	public:
		void AttachSimpleReverb(AudioSource& source);
		void AttachEqualizer(AudioSource& source);
		void AttachDelay(AudioSource& source);
		void AttachReverb(AudioSource& source);			//何故か64bitだと正しく反映されない
		void AttachLimiter(AudioSource& source);
		void Disable(AudioSource& source);
		void Enable(AudioSource& source);
	public:
		Equalizer_DESC		eq;
