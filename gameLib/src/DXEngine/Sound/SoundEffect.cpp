...
namespace AudioSystem
{
	...
	void SoundEffect::AttachSimpleReverb(AudioSource & source)
	{
	...
	void SoundEffect::AttachEqualizer(AudioSource & source)
	{
		//作成したいエフェクトの種類を設定(FXEQ,FXReverb,FXMasteringLimiter,FXEcho)
		IUnknown* effect;
	...
	void SoundEffect::AttachDelay(AudioSource & source)
	{
		//作成したいエフェクトの種類を設定(FXEQ, FXReverb, FXMasteringLimiter, FXEcho)
		IUnknown* effect;
	...
	void SoundEffect::AttachReverb(AudioSource & source)
	{
		IUnknown* effect;
	...
	void SoundEffect::AttachLimiter(AudioSource & source)
	{
		//作成したいエフェクトの種類を設定(FXEQ, FXReverb, FXMasteringLimiter, FXEcho)
		IUnknown* effect;
	...
	void SoundEffect::Disable(AudioSource & source)
	{
		source.GetSource()->DisableEffect(0);
	}
	void SoundEffect::Enable(AudioSource & source)
	{
